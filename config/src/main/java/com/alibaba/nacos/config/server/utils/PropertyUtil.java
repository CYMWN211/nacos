...
public class PropertyUtil implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    private void loadSetting() {
        try {
            ...
            // if configPlatform has not been configured or use DERBY as the database type
            setUseExternalDB(!"".equalsIgnoreCase(configPlatform)
                    || !DatabaseTypeConstant.DERBY.equalsIgnoreCase(configPlatform));
